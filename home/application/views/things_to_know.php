            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  ...
                  <div class="blog_details">
                    ...
                    <h5>Paypal</h5>
                     <p class="excert">
                        We use paypal to deliver your money to you. There is no minimum amount of credit required to debit your money. Paypal account can be added from dashboard.
                     </p>
                     <h5>Flat 10%</h5>
                     <p>
