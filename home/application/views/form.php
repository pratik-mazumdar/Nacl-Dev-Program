...
<body>
	...
	<div class="container-contact1">
			...
			<?php 	if ((array_key_exists("Email",$error_msg) ))
						echo '<div class="error text-center">'.$error_msg["Email"].'</div>';
					else if ((array_key_exists("Password",$error_msg) ))
						echo '<div class="error text-center">'.$error_msg["Password"].'</div>';
					else if ((array_key_exists("Company_Name",$error_msg) ))
						echo '<div class="error text-center">'.$error_msg["Company_Name"].'</div>';
					else if ((array_key_exists("OTP",$error_msg) ))
						echo '<div class="error text-center">'.$error_msg["OTP"].'</div>';
			?>
