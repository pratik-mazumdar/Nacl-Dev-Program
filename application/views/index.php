                    ...
                    <div class="col-xl-7 col-md-6">
                        <div class="slider_text ">
                            <h3 class="wow fadeInDown" data-wow-duration="1s" data-wow-delay=".1s" >Promote your<br> game
                                with Us</h3>
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s">Revolutionizing mobile gaming in a new way</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="single_service text-center wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".4s">
                        <div class="thumb">
                                <img src="<?php echo base_url(); ?>assets/img/icon/2.svg" alt="">
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInLeft" data-wow-duration=".4s" data-wow-delay=".5s">
                    <div class="man_thumb">
                        <img src="<?php echo base_url(); ?>assets/img/ilstrator_img/man_walk.png" alt="">
                    </div>
                </div>
                <div class="col-xl-5 offset-xl-1 col-lg-6 col-md-6 ">
                    <div class="mobile_screen wow fadeInRight" data-wow-duration=".8s" data-wow-delay=".5s">
                        <img src="<?php echo base_url(); ?>assets/img/ilstrator_img/mobile_screen.png" alt="">
                    </div>
                </div>
            </div>
                    ...
                    <div class="row  align-items-center">
                            <div class="col-xl-5 col-lg-5 offset-xl-1 offset-lg-1 col-md-6">
                                <div class="about_image wow fadeInLeft" data-wow-duration=".4s" data-wow-delay=".3s">
                                    <img src="<?php echo base_url(); ?>assets/img/ilstrator_img/phone.png" alt="">
                                </div>
                            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-md-12 col-lg-6">
                    <div class="app_download wow fadeInDown" data-wow-duration="1s" data-wow-delay=".1s">
                        <a href="#" >
                                <img src="<?php echo base_url(); ?>assets/img/ilstrator/app.svg" alt="">
                        </a>
                        <a href="#">
