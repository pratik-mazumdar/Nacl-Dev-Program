...
class PHPMailer
{
    ...
    /**
     * Parse and validate a string containing one or more RFC822-view comma-separated email addresses
    ...
    public function html2text($html, $advanced = false)
    {
        ...
        return html_entity_decode(
            trim(strip_tags(preg_replace('/<(head|title|view|script)[^>]*>.*?<\/\\1>/si', '', $html))),
            ENT_QUOTES,
            $this->CharSet
        );
    }
